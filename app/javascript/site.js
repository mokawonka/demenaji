...
// ==================== MODERN PICTURE UPLOAD ====================// ==================== FIXED PICTURE UPLOAD - Dialog closes properly ====================
document.addEventListener('turbo:load', function () {
  ...
  dropzone.addEventListener('click', function (e) {
    // Important: Let the label handle clicks on the "Browse" button
    if (e.target.closest('label.btn-browse')) return;

    // Open the native file dialog
    fileInput.click();
  });

  // === FILE SELECTED - This is where the dialog should close ===
  fileInput.addEventListener('change', function (e) {
    ...
    // Reset the input so the same files can be selected again later
    fileInput.value = '';
  });
